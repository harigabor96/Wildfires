...
### Decentralization, Democratization - Independent Data Marts
...
This modularity should also be reflected in the code structure in order to avoid breaking pipelines that are already in production during updates. This can be done by:
...
### Atomic and Flexible Structure - Schema Separation
...
### ELT over ETL - Dynamic Aggregation and Integration
