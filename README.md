...
This problem can be easily solved by keeping the DAG of each Data Mart as a "Forest" where Bronze tables are the trunks and Gold tables are the topmost branches. This approach is beneficial as the isolated Gold Tables provide maximum flexibility and performance for aggregation and integration, and also minimize storage and schema complexity.
