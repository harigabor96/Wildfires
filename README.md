...
Inmon also allowed persisting aggregations as long as the lowest granularity data is also persisted, however considering the nature of streaming and how common late arriving data is, it is only viable when the said aggregations are the result of commutative operations, like addition.
### Schema Separation
